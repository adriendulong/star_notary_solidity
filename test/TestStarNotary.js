...
it('lets 2 users exchange stars', async() => {
    ...
    assert.equal(await instance.ownerOf(starId1), owner1);
    await instance.createStar("star2", starId2, {from: owner2});
    assert.equal(await instance.ownerOf(starId2), owner2);
...
it('lookUptokenIdToStarInfo test', async() => {
    let instance = await StarNotary.deployed();
    await instance.createStar('AdrienStar', 11);
    assert.equal(await instance.lookUptokenIdToStarInfo(11), 'AdrienStar');
});